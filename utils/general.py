...
def user_config_dir(dir="Ultralytics", env_var="YOLOV5_CONFIG_DIR"):
    ...
    if env:
        path = Path(env)  # use environment varible
    else:
        cfg = {
            # "Windows": "E:/traffic-sign/traffic-sign-transfer-yolov5/roaming",
            "Windows": "F:/traffic-sign/traffic-sign-transfer-yolov5/roaming",
            "Linux": ".config",
