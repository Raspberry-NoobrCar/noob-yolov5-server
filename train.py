...
def parse_opt(known=False):
    ...
    parser.add_argument(
        "--weights",
        type=str,
        default=ROOT / "weight/yolov5l.pt",
        help="initial weights path",
    )
    parser.add_argument(
        "--cfg", type=str, default=ROOT / "models/yolov5l.yaml", help="model.yaml path"
    )
    parser.add_argument(
        "--data", type=str, default=ROOT / "data/emoji.yaml", help="dataset.yaml path"
    )
    parser.add_argument(
        "--hyp",
        type=str,
